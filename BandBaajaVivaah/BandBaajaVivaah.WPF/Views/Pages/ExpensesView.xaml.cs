...
namespace BandBaajaVivaah.WPF.Views.Pages
{
    ...
    public partial class ExpensesView : Page
    {
        ...
        public ExpensesView(ApiClientService apiClient, NavigationService navigationService, int weddingId)
        {
            ...
            DataContext = new ExpensesViewModel(apiClient, navigationService, weddingId);
        }
        ...
        {
            var formPage = new AddEditExpensesView(_apiClient, _navigationService, _weddingId);
        ...
        private void DataGrid_MouseDoubleClick(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            {
                var formPage = new AddEditExpensesView(_apiClient, _navigationService, _weddingId, ViewModel.SelectedItem);
                _navigationService.NavigateTo(formPage);
            }
        }
